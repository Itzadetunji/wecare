...
import { useForgotCompany } from "@/hooks/useCompanyData";
...
const ForgotPasswordPage: NextPage = () => {
	...
	return (
		<AuthenticationPageWrapper>
			...
			<form
				className="mt-[28px] lg:mt-[40px] flex flex-col gap-[30px]"
				method="post"
				onSubmit={(e) => {
					e.preventDefault();
			...
			<button
				className="text-white w-full h-[50px] lg:h-[60px] bg-[#552BCC] rounded-[5px] mt-[35px] lg:mt-[80px] lg:text-[20px] font-semibold"
				onClick={(e) => {
					e.preventDefault();
					handleForgotPassword();
				}}
